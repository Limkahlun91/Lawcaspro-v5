    ...
    await rlsDb.execute(sql`
      ...
      FROM (
        VALUES
          ...
          ('hr_settings','view'),('hr_settings','manage_organisation'),('hr_settings','manage_approval_flow'),('hr_settings','manage_feature_flags'),
          ('hr_employee','list'),('hr_employee','view'),('hr_employee','create'),('hr_employee','edit'),('hr_employee','status_change'),('hr_employee','terminate'),('hr_employee','reactivate'),('hr_employee','view_salary'),('hr_employee','edit_salary'),('hr_employee','view_bank'),('hr_employee','edit_bank'),
          ...
          ('hr_attendance','clock'),('hr_attendance','view_own'),('hr_attendance','view_all'),('hr_attendance','manage'),('hr_attendance','adjust'),('hr_attendance','approve_exception'),('hr_attendance','create'),('hr_attendance','read'),('hr_attendance','update'),
          ('hr_leave_balance','view_all'),('hr_leave_balance','adjust'),
          ('hr_leave','apply'),('hr_leave','view_own'),('hr_leave','cancel_own'),('hr_leave','view_all'),('hr_leave','approve'),('hr_leave','approve_final'),('hr_leave','manage_balance'),('hr_leave','create'),('hr_leave','read'),('hr_leave','update'),
          ('hr_claim','submit'),('hr_claim','view_own'),('hr_claim','cancel_own'),('hr_claim','view_all'),('hr_claim','approve'),('hr_claim','approve_final'),('hr_claim','send_to_payroll'),('hr_claim','send_to_accounting'),('hr_claim','mark_paid'),('hr_claim','create'),('hr_claim','read'),('hr_claim','update'),
          ('hr_payroll','view'),('hr_payroll','calculate'),('hr_payroll','submit'),('hr_payroll','approve'),('hr_payroll','lock'),('hr_payroll','request_payment'),('hr_payroll','reverse'),('hr_payroll','adjust'),('hr_payroll','supplementary_create'),('hr_payroll','manage_settings'),('hr_payroll','read'),('hr_payroll','create'),('hr_payroll','update'),
          ...
          ('hr_documents','view'),('hr_documents','upload'),('hr_documents','manage'),('hr_documents','view_confidential'),('hr_documents','view_sensitive'),
          ...
          ('hr_reports','view_headcount'),('hr_reports','view_turnover'),('hr_reports','view_leave_summary'),('hr_reports','view_payroll_summary'),('hr_reports','view_cost_analysis'),
          ('hr_notifications','view_overdue'),
          ('hr_self_service','read'),('hr_self_service','create'),('hr_self_service','view_profile'),('hr_self_service','edit_profile'),
          ('hr_payslip','view_own'),
