...
| DEP0169 url.parse() Audit | `docs/dep0169-url-parse-audit.md`. Own code grep 0 matches (WHATWG URL exclusive use). Dependency express 4.x only source (DEP0169 comes from express). Express 5 upgrade → vNEXT Stabilisation; no large bump in Bulk Sprint. NO bulk dep upgrade. |
