...
export const GetPlatformStatsResponse = zod.object({
  ...
  "recentFirms": zod.array(zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "slug": zod.string(),
  "subscriptionPlan": zod.string(),
...
export const GetDashboardStatsResponse = zod.object({
  ...
  "milestoneCards": zod.array(zod.object({
  "key": zod.string(),
  "label": zod.string(),
  ...
  "filter": zod.object({
  "milestone": zod.enum(['spa_date', 'spa_stamped_date', 'letter_of_offer_date', 'letter_of_offer_stamped_date', 'loan_docs_pending_date', 'loan_docs_signed_date', 'acting_letter_issued_date', 'developer_confirmation_received_on', 'loan_sent_bank_execution_date', 'loan_bank_executed_date', 'bank_lu_received_date', 'advice_to_bank_date', 'bank_lu_forward_to_developer_on', 'developer_lu_received_on', 'developer_lu_dated', 'register_poa_on', 'letter_disclaimer_dated', 'loan_agreement_stamped_date', 'bank_1st_release_on', 'discharge_date', 'caveat_lodged_date', 'first_advice_date', 'dev_informed_redemption_date', 'request_discharge_date', 'charge_date', 'presentation_date', 'second_advice_date', 'mot_received_date', 'mot_signed_date', 'mot_stamped_date', 'mot_registered_date', 'noa_served_on', 'completion_date', 'file_opened', 'spa_stamped', 'lof_stamped', 'loan_docs_pending', 'loan_docs_signed', 'acting_letter_pending', 'acting_letter_issued', 'advised', 'loan_pending_bank_exec', 'loan_sent_bank_exec', 'loan_bank_executed', 'blu_received', 'blu_confirmed', 'mot_pending', 'mot_received', 'mot_invoice_prepare', 'mot_stamp_received', 'mot_submitted_stamping', 'mot_stamp', 'noa_prepare', 'noa_served', 'pa_pending', 'pa_registered', 'letter_disclaimer']),
  "milestonePresence": zod.enum(['filled', 'missing', 'completed', 'pending']),
...
export const ListProjectsQueryParams = zod.object({
  ...
  "sortBy": zod.enum(['updatedAt', 'createdAt', 'referenceNo', 'spaDate']).optional(),
...
export const ListProjectsResponse = zod.object({
  ...
  "extraFields": zod.object({

}).passthrough().describe('Dynamic fields (landed\/highrise specific)'),
  "caseCount": zod.number(),
  "createdAt": zod.coerce.date()
})),
  "total": zod.number(),
...
export const ListCasesQueryParams = zod.object({
  "search": zod.coerce.string().optional().describe('Keyword search across reference, client\/purchaser, project, and property'),
  "status": zod.coerce.string().optional(),
  ...
  "milestone": zod.enum(['spa_date', 'spa_stamped_date', 'letter_of_offer_date', 'letter_of_offer_stamped_date', 'loan_docs_pending_date', 'loan_docs_signed_date', 'acting_letter_issued_date', 'developer_confirmation_received_on', 'loan_sent_bank_execution_date', 'loan_bank_executed_date', 'bank_lu_received_date', 'advice_to_bank_date', 'bank_lu_forward_to_developer_on', 'developer_lu_received_on', 'developer_lu_dated', 'register_poa_on', 'letter_disclaimer_dated', 'loan_agreement_stamped_date', 'bank_1st_release_on', 'discharge_date', 'caveat_lodged_date', 'first_advice_date', 'dev_informed_redemption_date', 'request_discharge_date', 'charge_date', 'presentation_date', 'second_advice_date', 'mot_received_date', 'mot_signed_date', 'mot_stamped_date', 'mot_registered_date', 'noa_served_on', 'completion_date', 'file_opened', 'spa_stamped', 'lof_stamped', 'loan_docs_pending', 'loan_docs_signed', 'acting_letter_pending', 'acting_letter_issued', 'advised', 'loan_pending_bank_exec', 'loan_sent_bank_exec', 'loan_bank_executed', 'blu_received', 'blu_confirmed', 'mot_pending', 'mot_received', 'mot_invoice_prepare', 'mot_stamp_received', 'mot_submitted_stamping', 'mot_stamp', 'noa_prepare', 'noa_served', 'pa_pending', 'pa_registered', 'letter_disclaimer']).optional(),
  "milestonePresence": zod.enum(['filled', 'missing', 'completed', 'pending']).optional(),
...
export const GetCaseStatsByStatusResponse = zod.array(GetCaseStatsByStatusResponseItem)
...
export const GetCaseStatsByTypeResponse = zod.array(GetCaseStatsByTypeResponseItem)
