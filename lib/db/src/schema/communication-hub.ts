...
export const communicationMessagesTable = pgTable("communication_messages", {
  ...
  emailFolderId: integer("email_folder_id"),
  channel: text("channel").notNull(),
  provider: text("provider").notNull(),
  ...
  firmEmailAccountIdx: index("idx_communication_messages_firm_email_account").on(t.firmId, t.emailAccountId, t.createdAt),
  firmEmailFolderIdx: index("idx_communication_messages_firm_email_folder").on(t.firmId, t.emailFolderId, t.createdAt),
...
export const communicationEmailAccountsTable = pgTable("communication_email_accounts", {
  ...
  oauthScopes: jsonb("oauth_scopes").$type<string[]>().notNull().default([]),
